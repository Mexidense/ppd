    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <div className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2 lg:gap-6 xl:grid-cols-4">
            {/* Total Documents */}
        ...
        {topDocuments.length > 0 && topDocuments.some(d => d.purchases > 0) && (
          <div className="mb-6 lg:mb-8">
            <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Document Performance</h3>
            <Card className="shadow-md">
              <CardHeader>
                <CardTitle className="text-sm sm:text-base">Top Performing Documents</CardTitle>
                    ...
                    .map((doc, index) => (
                      ...
                      >
                        <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 flex-1 min-w-0">
                          <div className="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-primary/10 text-primary text-sm sm:text-base font-bold flex-shrink-0">
                            {index + 1}
                          </div>
                          <div className="flex-1 min-w-0">
                            <h4 className="text-sm sm:text-base font-semibold truncate" title={doc.title}>
                              {doc.title}
                            </h4>
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6 lg:grid-cols-2">
          ...
          <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
            <CardHeader>
              <CardTitle className="text-base sm:text-lg">Daily Purchases</CardTitle>
              <p className="text-xs sm:text-sm text-muted-foreground">
              ...
              {dailyStats.length === 0 || dailyStats.every(d => d.purchases === 0) ? (
                ...
                <div className="h-[250px] sm:h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={dailyStats} margin={{ top: 5, right: 10, left: -10, bottom: 5 }}>
                      <CartesianGrid 
                        strokeDasharray="3 3" 
          ...
          <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
            <CardHeader>
              <CardTitle className="text-base sm:text-lg">Daily Revenue</CardTitle>
              <p className="text-xs sm:text-sm text-muted-foreground">
            ...
            <CardContent>
              {dailyStats.length === 0 || dailyStats.every(d => d.revenue === 0) ? (
                <div className="h-[250px] sm:h-[300px] flex items-center justify-center">
                  <div className="text-center">
                    <DollarSign className="h-10 w-10 sm:h-12 sm:w-12 text-muted-foreground mx-auto mb-2" aria-hidden="true" />
                    <p className="text-xs sm:text-sm text-muted-foreground">No revenue yet</p>
                    <p className="text-xs text-muted-foreground mt-1">
